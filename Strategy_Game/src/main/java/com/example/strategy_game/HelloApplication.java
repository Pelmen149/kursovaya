...
public class HelloApplication extends Application {
    ...
    public static void main_menu_window(){
        ...
        main_menu.getChildren().addAll(newgame, load);
    ...
    public void start(Stage stage) throws IOException {
        ...
        load.setOnAction(new EventHandler<ActionEvent>() {
             ...
             * @param event Активна при нажатии на неё
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        newgame.setOnAction(new EventHandler<ActionEvent>() {
            /** Кнопка новая игра
             * @param event При нажатии запускает новую игру
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        next.setOnAction(new EventHandler<ActionEvent>() {
            /** Следующий ход
             * @param event При нажатии на кнопку пропускает ход и проводит ход противника
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        change.setOnAction(new EventHandler<ActionEvent>() {
             ...
             * @param event при нажатии меняется режим отображаемой карты
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        buttons[0].setOnAction(new EventHandler<ActionEvent>() {
             ...
             * @param event При нажатии происходит сохранение файла в папку "Saves" на диске "C:\\" с указанным названием
             */
            @Override
            public void handle(ActionEvent event) {
                logger.info("Confirmation of saving button was clicked");
                new File("C:\\Strategy Game\\Saves").mkdirs();
                try(FileWriter writer = new FileWriter("C:\\Strategy Game\\Saves\\"+ save_field.getText() +".save", false))
                {
                    String text="";
        ...
        buttons[1].setOnAction(new EventHandler<ActionEvent>() {
             ...
             * @param event При нажатии открывается окно ввода названия сохранения
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        buttons[2].setOnAction(new EventHandler<ActionEvent>() {
            /**Кнопка показа карты
             * @param event При нажатии отображает карту, если она была по какой то причине закрыта
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        buttons[3].setOnAction(new EventHandler<ActionEvent>() {
             ...
             * @param event При нажатии открывается меню покупки полей
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        buttons[4].setOnAction(new EventHandler<ActionEvent>() {
             ...
             * @param event При нажатии и достаточном количестве ресурсов происходит постройка дома
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        buttons[5].setOnAction(new EventHandler<ActionEvent>() {
            /**Кнопка добычи воды
             * @param event При нажатии и достаточном количестве крестьян происходит добыча воды
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        buttons[6].setOnAction(new EventHandler<ActionEvent>() {
            /**Кнопка поливки риса
             * @param event При нажатии и достаточном количестве воды происходит поливка риса
             */
            @Override
            public void handle(ActionEvent event) {
        ...
        buttons[7].setOnAction(new EventHandler<ActionEvent>() {
            /**Кнопка сбора риса
             * @param event При нажатии и достаточном количестве крестьян происходит сбор риса
             */
            @Override
            public void handle(ActionEvent event) {
                logger.info("Collecting home button was clicked");
                if (game.peasants.count > 0){
                    game.peasants.count-=1;
        ...
        field_stage.setOnCloseRequest(new EventHandler<WindowEvent>() {
            /**Событие активации кнопки показа карты
             * @param we Когда карта закрывается, становится активна кнопка для её показа
             */
